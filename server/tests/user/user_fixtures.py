...
class UserFixtures(AppContextFixture):
    ...
    def users(self, app_context) -> Users:
        ...
        all_roles = UserService.add_user(self.USER_ALL_ROLES_EMAIL,
                                         [UserRole.ADMIN, UserRole.AD_MANAGER, UserRole.CARBON_AUDITOR])
        return self.Users(admin=admin, ad_manager=ad_manager, carbon_auditor=carbon_auditor, all_roles=all_roles)
