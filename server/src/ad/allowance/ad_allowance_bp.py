...
from src.ad.strategy.ad_strategy import AD_RATE_LIMIT_WINDOW_DURATION
...
def get_all():
    ...
    dtos = [AdAllowanceDTO(business_id=business_id,
                           window_start=allowance.window_start.date(),
                           window_end=(allowance.window_start + AD_RATE_LIMIT_WINDOW_DURATION).date(),
